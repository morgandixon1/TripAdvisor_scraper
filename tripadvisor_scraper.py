...
def find_urls(url):
  ...
  for div_node in div_nodes:
    ...
    urls.extend([(text, "https://www.tripadvisor.com" + anchor.attrib['href']) for anchor in anchor_nodes])

  return urls

# Set the base URL
base_url = "https://www.tripadvisor.com/search?find_desc=&find_loc=hillsboro%2C+OR"
